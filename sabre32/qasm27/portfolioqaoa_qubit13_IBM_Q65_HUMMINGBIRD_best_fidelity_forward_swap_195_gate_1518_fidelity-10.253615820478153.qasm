...
rz(0.27550909) q[46];
cx q[45],q[46];
rz(1.28622623620148) q[46];
cx q[45],q[46];
cx q[45],q[39];
rz(1.28623245942667) q[39];
cx q[45],q[39];
cx q[45],q[44];
...
swap q[25],q[33];
cx q[25],q[19];
rz(1.28619994098902) q[19];
cx q[25],q[19];
swap q[19],q[25];
cx q[19],q[20];
rz(1.2862006351415) q[20];
cx q[19],q[20];
cx q[19],q[18];
rz(1.28627017241237) q[18];
cx q[19],q[18];
swap q[18],q[19];
cx q[18],q[17];
rz(1.28629172757182) q[17];
cx q[18],q[17];
sx q[18];
rz(-2.281621) q[18];
sx q[18];
...
swap q[19],q[25];
cx q[19],q[20];
rz(1.28615185197529) q[20];
cx q[19],q[20];
cx q[19],q[25];
rz(1.28651700416207) q[25];
cx q[19],q[25];
cx q[19],q[18];
...
swap q[31],q[30];
cx q[32],q[33];
rz(1.28626755508071) q[33];
cx q[32],q[33];
swap q[33],q[32];
swap q[25],q[33];
cx q[25],q[19];
rz(1.28625353071453) q[19];
cx q[25],q[19];
cx q[25],q[33];
rz(1.2862234528668) q[33];
cx q[25],q[33];
swap q[19],q[25];
cx q[19],q[20];
rz(1.28623527992594) q[20];
cx q[19],q[20];
rz(-pi/2) q[19];
sx q[19];
rz(-2.281621) q[19];
...
cx q[31],q[30];
cx q[31],q[39];
rz(1.28620062905602) q[39];
cx q[31],q[39];
swap q[32],q[31];
cx q[32],q[33];
rz(1.28619853115547) q[33];
cx q[32],q[33];
cx q[32],q[31];
rz(1.28629913321126) q[31];
cx q[32],q[31];
swap q[31],q[30];
swap q[33],q[32];
swap q[33],q[25];
cx q[25],q[19];
rz(1.28620281928292) q[19];
cx q[25],q[19];
rz(-pi/2) q[25];
sx q[25];
rz(-2.281621) q[25];
...
swap q[39],q[45];
cx q[39],q[31];
rz(1.28623160973901) q[31];
cx q[39],q[31];
cx q[39],q[45];
rz(1.28621691869742) q[45];
cx q[39],q[45];
swap q[31],q[39];
cx q[31],q[32];
rz(1.28621194347753) q[32];
cx q[31],q[32];
cx q[31],q[30];
rz(1.2862428644037) q[30];
cx q[31],q[30];
swap q[32],q[31];
cx q[32],q[33];
rz(1.28619386506415) q[33];
cx q[32],q[33];
rz(-pi/2) q[32];
sx q[32];
rz(-2.281621) q[32];
...
swap q[31],q[39];
cx q[31],q[30];
rz(1.28601742924833) q[30];
cx q[31],q[30];
cx q[31],q[39];
rz(1.28670539841202) q[39];
cx q[31],q[39];
rz(-pi/2) q[31];
sx q[31];
rz(-2.281621) q[31];
...
swap q[25],q[19];
cx q[20],q[19];
rz(3.89431160861977) q[19];
cx q[20],q[19];
cx q[25],q[19];
rz(3.89284568043) q[19];
cx q[25],q[19];
swap q[33],q[25];
cx q[25],q[19];
...
swap q[39],q[45];
cx q[39],q[31];
rz(1.28617339449342) q[31];
cx q[39],q[31];
cx q[39],q[45];
rz(1.28626193843928) q[45];
cx q[39],q[45];
rz(-pi/2) q[39];
sx q[39];
rz(-2.281621) q[39];
...
swap q[33],q[25];
cx q[19],q[25];
rz(3.89376436583286) q[25];
cx q[19],q[25];
swap q[25],q[19];
cx q[18],q[19];
rz(3.89376421444789) q[19];
cx q[18],q[19];
cx q[20],q[19];
...
cx q[45],q[46];
cx q[45],q[39];
rz(1.28616579173036) q[39];
cx q[45],q[39];
cx q[45],q[44];
rz(1.28635016575784) q[44];
cx q[45],q[44];
rz(-pi/2) q[45];
sx q[45];
rz(-2.281621) q[45];
...
swap q[33],q[25];
cx q[19],q[25];
rz(3.89371974076868) q[25];
cx q[19],q[25];
swap q[25],q[19];
cx q[20],q[19];
rz(3.8938843295236) q[19];
cx q[20],q[19];
swap q[19],q[18];
cx q[17],q[18];
...
swap q[25],q[19];
cx q[20],q[19];
rz(3.8931090236601) q[19];
cx q[20],q[19];
cx q[25],q[19];
rz(3.8931158332981) q[19];
cx q[25],q[19];
swap q[33],q[25];
cx q[25],q[19];
...
swap q[31],q[39];
cx q[31],q[32];
rz(1.4522997642028) q[32];
cx q[31],q[32];
swap q[45],q[46];
cx q[45],q[44];
rz(1.45236364931787) q[44];
cx q[45],q[44];
cx q[45],q[39];
rz(1.45256961671386) q[39];
cx q[45],q[39];
swap q[39],q[45];
swap q[31],q[39];
cx q[31],q[32];
rz(1.45242291497052) q[32];
cx q[31],q[32];
cx q[44],q[45];
...
rz(0.11838521) q[20];
cx q[32],q[33];
rz(1.45228038198864) q[33];
cx q[32],q[33];
cx q[32],q[31];
rz(1.45253609656694) q[31];
cx q[32],q[31];
swap q[31],q[30];
swap q[33],q[32];
cx q[31],q[32];
rz(1.45158452686446) q[32];
cx q[31],q[32];
cx q[31],q[30];
rz(1.45225465748409) q[30];
cx q[31],q[30];
swap q[32],q[31];
cx q[33],q[25];
...
swap q[17],q[18];
cx q[32],q[33];
rz(1.45222160668495) q[33];
cx q[32],q[33];
swap q[33],q[32];
cx q[33],q[25];
rz(1.45220617607096) q[25];
cx q[33],q[25];
swap q[25],q[33];
swap q[19],q[25];
cx q[19],q[20];
rz(1.45216568150651) q[20];
cx q[19],q[20];
cx q[19],q[25];
rz(1.45257796678476) q[25];
cx q[19],q[25];
cx q[19],q[18];
...
swap q[25],q[33];
cx q[25],q[19];
rz(1.4522804847278) q[19];
cx q[25],q[19];
cx q[25],q[33];
rz(1.45224652449349) q[33];
cx q[25],q[33];
swap q[19],q[25];
cx q[19],q[18];
...
swap q[45],q[46];
cx q[45],q[44];
rz(1.45224782232214) q[44];
cx q[45],q[44];
cx q[45],q[46];
rz(1.45234236413606) q[46];
cx q[45],q[46];
swap q[39],q[45];
swap q[31],q[39];
cx q[31],q[30];
rz(1.45248634246429) q[30];
cx q[31],q[30];
swap q[39],q[45];
cx q[31],q[39];
rz(1.45225579069993) q[39];
cx q[31],q[39];
swap q[45],q[39];
cx q[31],q[39];
rz(1.45222075463226) q[39];
cx q[31],q[39];
swap q[32],q[31];
cx q[32],q[33];
...
swap q[45],q[44];
cx q[45],q[46];
rz(1.45233456330507) q[46];
cx q[45],q[46];
swap q[39],q[45];
cx q[39],q[31];
rz(1.45210863527348) q[31];
cx q[39],q[31];
swap q[45],q[46];
swap q[45],q[39];
cx q[39],q[31];
rz(1.45240753714719) q[31];
cx q[39],q[31];
cx q[45],q[44];
rz(1.45225573423794) q[44];
cx q[45],q[44];
cx q[45],q[46];
rz(1.45223914690699) q[46];
cx q[45],q[46];
swap q[39],q[45];
swap q[39],q[31];
cx q[31],q[32];
...
swap q[33],q[32];
cx q[45],q[44];
rz(1.45220435690649) q[44];
cx q[45],q[44];
cx q[45],q[46];
rz(1.45230053351131) q[46];
cx q[45],q[46];
swap q[45],q[39];
cx q[39],q[31];
...
swap q[30],q[31];
cx q[45],q[44];
rz(1.45246212320329) q[44];
cx q[45],q[44];
cx q[45],q[46];
rz(1.45238411018228) q[46];
cx q[45],q[46];
cx q[45],q[39];
...
swap q[45],q[44];
cx q[45],q[46];
rz(1.45224920931241) q[46];
cx q[45],q[46];
cx q[45],q[44];
rz(1.45225086725688) q[44];
cx q[45],q[44];
cx q[45],q[39];
