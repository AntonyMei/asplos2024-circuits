...
def sabre_round(seed, qasm_file_name, device_name):
    ...
    return sabre_swap_count, sabre_gate_count, logical2physical, sabre_circuit, 0
...
def main():
    ...
    dirs = {"./qasm_files/qasm27": "./sabre1000/qasm27",
            "./qasm_files/qasm65": "./sabre1000/qasm65",
            "./qasm_files/quartz": "./sabre1000/quartz"}
