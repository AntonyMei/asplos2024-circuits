...
sx node[1];
sx node[2];
rz(0.6785984164955225*pi) node[3];
sx node[4];
sx node[5];
sx node[6];
sx node[10];
...
rz(0.5*pi) node[21];
rz(0.5*pi) node[25];
rz(3.318736247503506*pi) node[33];
cx node[3],node[4];
rz(0.4285984039306657*pi) node[4];
cx node[3],node[4];
cx node[3],node[2];
rz(3.5714015960693377*pi) node[4];
rz(3.857196807861328*pi) node[2];
swap node[5],node[4];
cx node[3],node[2];
swap node[6],node[5];
rz(0.1428031921386718*pi) node[2];
swap node[3],node[2];
cx node[2],node[1];
swap node[4],node[3];
...
cx node[1],node[0];
swap node[3],node[2];
rz(0.42878723144531244*pi) node[0];
swap node[4],node[3];
cx node[1],node[0];
swap node[5],node[4];
rz(3.5712127685546875*pi) node[0];
swap node[10],node[0];
cx node[1],node[0];
swap node[13],node[10];
rz(3.857574462890625*pi) node[0];
swap node[14],node[13];
cx node[1],node[0];
swap node[15],node[14];
rz(0.14242553710937503*pi) node[0];
swap node[10],node[0];
cx node[1],node[0];
swap node[13],node[10];
rz(3.7151489257812504*pi) node[0];
swap node[14],node[13];
cx node[1],node[0];
rz(0.28485107421875006*pi) node[0];
swap node[10],node[0];
cx node[1],node[0];
swap node[13],node[10];
rz(0.4302978515624996*pi) node[0];
cx node[1],node[0];
rz(3.5697021484375004*pi) node[0];
cx node[1],node[2];
swap node[10],node[0];
rz(3.860595703125*pi) node[2];
cx node[1],node[2];
rz(0.13940429687500014*pi) node[2];
swap node[3],node[2];
cx node[1],node[2];
swap node[4],node[3];
rz(3.7211914062500004*pi) node[2];
swap node[11],node[4];
cx node[1],node[2];
cx node[1],node[0];
rz(0.27880859374999994*pi) node[2];
rz(0.4423828124999997*pi) node[0];
swap node[3],node[2];
cx node[1],node[0];
rz(3.5585937602650546*pi) node[0];
cx node[1],node[2];
rz(3.884765625*pi) node[2];
cx node[1],node[2];
rz(0.11523437499999989*pi) node[2];
cx node[3],node[2];
cx node[2],node[3];
cx node[3],node[2];
...
swap node[2],node[3];
cx node[3],node[4];
rz(3.769531249999999*pi) node[4];
cx node[3],node[4];
rz(0.2304687500000001*pi) node[4];
cx node[11],node[4];
cx node[4],node[11];
cx node[11],node[4];
...
cx node[17],node[16];
swap node[4],node[5];
rz(3.5390624999999987*pi) node[16];
cx node[17],node[16];
rz(0.4609375000000015*pi) node[16];
cx node[17],node[18];
swap node[16],node[15];
rz(0.07812500000000014*pi) node[18];
swap node[15],node[14];
cx node[17],node[18];
swap node[14],node[13];
rz(3.921875*pi) node[18];
cx node[10],node[13];
...
cx node[10],node[13];
swap node[16],node[15];
rz(0.15624999999999994*pi) node[19];
...
cx node[16],node[17];
rz(0.3125*pi) node[20];
swap node[13],node[14];
cx node[17],node[16];
cx node[19],node[20];
cx node[16],node[17];
cx node[19],node[25];
rz(3.6875*pi) node[20];
...
swap node[4],node[11];
sx node[25];
rz(0.8187362537472533*pi) node[33];
cx node[5],node[4];
rz(3.25*pi) node[25];
cx node[4],node[5];
...
rz(3.75*pi) node[14];
rz(0.5*pi) node[13];
barrier node[8],node[6],node[19],node[20],node[25],node[18],node[3],node[0],node[1],node[2],node[5],node[4],node[11],node[17],node[16],node[15],node[10],node[14],node[13],node[33];
